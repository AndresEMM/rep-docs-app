                ...
                <div className="container-cabecera">
                    <div className="row no-gutters">
                        <div className="col-md-12">
                            <div className="d-inline-block ipnLogo-enlace">
                                <a href="https://www.gob.mx/" target="_blank" id="pleca_1" rel="noopener noreferrer">
                                    <img src={pg1} alt="Gobierno de México" className="plecaGob gob"/>
                                </a>
                                <a href="https://www.gob.mx/sep" target="_blank" id="pleca_2" rel="noopener noreferrer">
                                    <img src={pg2} alt="Educación" className="plecaGob gob"/>
                                </a>
                                <a href="inicio.aspx" id="pleca_3" rel="noopener noreferrer">
                    ...
                    <div className="contenedorAccesibilidad">  
                        <div className="idiomas text-right">
                            <a href="https://login.microsoftonline.com/?whr=tecnm.mx" title="Correo Institucional" target="_blank" rel="noopener noreferrer">
                                <img src={cor} alt="Buzón"/>
                            </a>
                            <a href="pdf/Calendario_Academico_2019-2020.pdf" title="Calendario Académico" target="_blank" rel="noopener noreferrer">
                                <img src={cal} alt="Calendario Académico"/>
                            </a>
                            <a href="inicio.aspx" target="_blank" rel="noopener noreferrer">
                            ...
                            <a href="inicio.aspx" target="_blank" className="mr-3" rel="noopener noreferrer">
                            ...
                            <a className="btn--accesibilidad contraste" target="_blank" rel="noopener noreferrer">
                            ...
                            <a className="btn--accesibilidad aumentaLetra " target="_blank" title="Aumentar letra" rel="noopener noreferrer">A+</a>
                            <a className="btn--accesibilidad reduceLetra" target="_blank" title="Disminuir letra" rel="noopener noreferrer">A-</a>
                            <a className="btn--accesibilidad resetLetra" target="_blank" title="Restablecer tamaño" rel="noopener noreferrer">A </a>
                        </div>
                    </div>
                </div>
            </div>
